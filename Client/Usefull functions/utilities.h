...
// single thread
void writeLog(const std::ostringstream& str, const std::string& log_path);
void writeLogAndClear(std::ostringstream& str, const std::string& log_path);
